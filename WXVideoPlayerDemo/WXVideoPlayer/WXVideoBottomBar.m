...
@implementation WXVideoBottomBar

- (UIButton *)playPauseBtn {
    
    if (!_playPauseBtn) {
        _playPauseBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [_playPauseBtn setImage:[UIImage imageNamed:WXVideoPlayerImageName(@"pause")] forState:UIControlStateNormal];
...
- (UIButton *)changeScreenBtn {
    ...
    if (!_changeScreenBtn) {
        ...
        [_changeScreenBtn setImage:[UIImage imageNamed:WXVideoPlayerImageName(@"full_screen")] forState:UIControlStateNormal];
...
- (UISlider *)videoProgressSlider {
    ...
    if (!_videoProgressSlider) {
        ...
        [_videoProgressSlider setThumbImage:[UIImage imageNamed:WXVideoPlayerImageName(@"dot")] forState:UIControlStateNormal];
...
+ (instancetype)videoBottomBar {
    ...
    return [[WXVideoBottomBar alloc] init];
}
